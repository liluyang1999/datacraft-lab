 ...
 * inferSchema, multiLine, escape (contract: docs/data-processing.md). The input must be a literal
 ...
 * docs/data-processing.md). CSV and JSON are read in FAILFAST mode and counted over complete
