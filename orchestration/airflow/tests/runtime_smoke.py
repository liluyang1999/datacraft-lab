...
def sftp_source(source):
    ...
    class Server(paramiko.ServerInterface):
        def check_auth_password(self, username, value):
            return paramiko.AUTH_SUCCESSFUL if username == "datacraft-test" and value == password else paramiko.AUTH_FAILED
    ...
    class Files(paramiko.SFTPServerInterface):
        ...
        def open(self, path, flags, attr):
            ...
            handle.readfile = source.open("rb")
            return handle
    ...
    try:
        yield {
            ...
            "login": "datacraft-test", "password": password,
